...
class Config(object):
    ...
    @property
    def shuffle(self):
        return self._config.getboolean('Train', 'shuffle')

    @property
    def domain_adv(self):
        return self._config.getboolean('Train', 'domain_adv')

    @property
    def fp16(self):
        return self._config.getboolean('Train', 'fp16')

    @property
    def fp16_opt_level(self):
        return self._config.get('Train', 'fp16_opt_level')
    ...
    @property
    def domain_lr(self):
        return self._config.getfloat('Model', 'domain_lr')
